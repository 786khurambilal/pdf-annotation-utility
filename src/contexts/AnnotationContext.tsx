...
interface AnnotationContextType {
  ...
  createCallToAction: (pageNumber: number, url: string, label: string, coordinates: RectangleCoordinates) => Promise<CallToAction>;
  updateCallToAction: (ctaId: string, updates: Partial<Pick<CallToAction, 'url' | 'label'>>) => Promise<CallToAction>;
